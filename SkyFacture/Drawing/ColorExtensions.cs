...
{
	/// <summary>
	/// Use this method instead <seealso cref="Move(Color, Single)"/>, when you need to invert color (rotate hue by 180)
	/// </summary>
	/// <param name="color"></param>
	/// <returns></returns>
	public static Color Invert(this Color color)
		=> Color.FromArgb(color.ToArgb() ^ 0xffffff);
    public static Color Move(this Color color, float move)
	{
        ColorToHSV(color, out double hue, out double saturation, out double brightness);
        hue = MathA.Range(hue + move, 360);
